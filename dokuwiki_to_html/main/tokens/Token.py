...
class Token:
    ...
    def is_heading(self):
        if self.token in [TokenType.heading_level1, TokenType.heading_level2, TokenType.heading_level3, TokenType.heading_level4, TokenType.heading_level5, TokenType.heading_level6]:
            return True
        else:
            return False

    def is_formatted(self):
        if self.token in [TokenType.text_del_begin, TokenType.text_bold_symbol, TokenType.text_italics_symbol, TokenType.text_underlined_symbol, TokenType.text_monospaced_symbol, TokenType.text_sub_begin, TokenType.text_sup_begin]:
            return True
        else:
            return False
